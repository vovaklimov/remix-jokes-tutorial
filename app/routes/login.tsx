...
import { createUserSession, login, registerUser } from '~/services/session.server';
import { findUserByUsername } from '~/services/users.server';
...
export const action: ActionFunction = async ({ request }) => {
  ...
  switch (loginType) {
    case 'login': {
      ...
      return user
        ? createUserSession(user?.id, redirectTo)
        : badRequest({
            fields,
